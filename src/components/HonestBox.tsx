...
import HonestBoxAdminView from './honest-box/HonestBoxAdminView';
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">HonestBox</h1>
      ...
      {updates.length > 0 && (
        <Card>
          ...
          <CardContent className="space-y-4">
            {updates.map((update) => (
              <div key={update.id} className="border-l-4 border-purple-500 pl-3 sm:pl-4 py-2">
